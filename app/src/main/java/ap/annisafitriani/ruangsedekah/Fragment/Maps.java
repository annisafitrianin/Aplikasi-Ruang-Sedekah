...
//        LatLng sydney = new LatLng(-7.951837, 112.613207);
//        googleMap.addMarker(new MarkerOptions().position(sydney).title("Marker in UB"));
...
//
//
//        LatLng stasiun = new LatLng(-7.9535926, 112.614531);
...
public class Maps extends Fragment implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
    ...
    private ImageView mCurrentLoc, mInfo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle SavedInstanceState) {
        ...
        createEvent = mView.findViewById(R.id.create_event);
        mCurrentLoc = mView.findViewById(R.id.current_location);
    ...
    private void init(){
        ...
        mInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d(TAG, "onClick: clicked info kegiatan");
                try{
                    if(mMarker.isInfoWindowShown()){
                        mMarker.hideInfoWindow();
                    }else{
                        Log.d(TAG, "onClick: info kegiatan: " + mKegiatan.toString());
    ...
    private void geoLocate(){
        ...
        Geocoder geocoder = new Geocoder(Maps.this.getActivity());
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Maps.this.getActivity(), "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
